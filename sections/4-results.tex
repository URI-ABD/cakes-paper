...
% I think I should vary the wording more but just getting down the key observations for now
...
Figure~\ref{fig:results:sift-lfd} shows the local fractal dimension by depth for the sift dataset. 
