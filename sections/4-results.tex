...
{\color{red} TODO: Combine the following four paragraphs into a single, larger paragraph that summarizes the results across all datasets. There is too much repetition here.}
