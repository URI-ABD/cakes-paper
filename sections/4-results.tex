...
We note that on this dataset, depth-first reordering (the Permuted plotlines) seems to have little effect; depth-first reordering is intended to improve space complexity only.
