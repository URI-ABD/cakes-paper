...
%                     \hline
%                     \textbf{Dataset}  & \multicolumn{2}{|c|}{\textbf{faiss-ivf}} & \multicolumn{2}{|c|}{\textbf{faiss-flat}} & \multicolumn{2}{|c|}{\textbf{hnsw(faiss)}} & \multicolumn{2}{|c|}{\textbf{CAKES}} \\
%                     \cline{2-9}
%                     &               Recall & Throughput      & Recall & Throughput    & Recall & Throughput    & Recall & Throughput \\
%                     \hline
...
% \begin{table*}[!t]
%     % \renewcommand{\arraystretch}{1.15}
%     \caption{Runtime performance (queries per second) of CAKES vs. other methods on fashion-mnist dataset}
...
%                     \hline
%                     \textbf{Scaling Factor}  & \multicolumn{2}{|c|}{\textbf{faiss-ivf}} & \multicolumn{2}{|c|}{\textbf{faiss-flat}} & \multicolumn{2}{|c|}{\textbf{annoy}} & \multicolumn{2}{|c|}{\textbf{HNSW}} & \multicolumn{2}{|c|}{\textbf{CAKES}} \\
%                     &             Recall & QPS        & Recall & QPS     & Recall & QPS      & Recall & QPS     & Recall & QPS \\
%                     \hline
%                     1.00          & -- & --           & --     & --      & -- & --           & --     & --      & -- & --   \\
%                     \hline
%                     2.00          & -- & --           & --     & --      & -- & --           & --     & --      & -- & --   \\
