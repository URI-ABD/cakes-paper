...
We also note that the CAKES algorithm with the best throughput varies across different datasets.
...
Such online updates would take advantage of the fast search algorithm provided by CAKES.  % and would allow us to have our cake and eat it, too.
