...
This suggests that rather than use the reciprocal of the \textit{harmonic} mean LFD in~\ref{eq:methods:repeated-rnn-factor}, we may actually want a mean which is more sensitive to high outliers, such as the geometric mean.
