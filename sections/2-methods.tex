...
% Najib: Add an equation for local fractal dimension with the simplification from the previous sentence.

% Najib: Rewrite this paragraph. Old paper defined it as ... but we define it for the hierarchical clustering scheme as ...
...
% Najib: Remove Sharding from this subsection. We do not show sharding in any of our benchmarks. All benchmarks are done with datasets that fit in memory (on giant machines, but still).
...
% Najib: This is laid out in Algorithm 2. We should reference that algorithm here.
...
% Najib: I don't like the double vertical bars for norm-notion. I think it's too messy. We should just overload the notation of the single horizontal bar across the top.
% Najib: Remove the equation numbers from this paragraph. They're not necessary.
...
% Najib: Move the cluster.isLeaf check to the beginning of the algorithm because it's the base case.
\begin{algorithm} 
