...
$r_1, r_2, \cdots r_d$ in the interval $[-\tfrac{\epsilon}{\sqrt{d}}, \tfrac{\epsilon}{\sqrt{d}}]$ and then add them componentwise to the original datapoint. 
This ensures that any synthetic point is within a distance of $\epsilon$ from a real point in the original dataset.
