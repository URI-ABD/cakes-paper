...
However, due to physical constraints (namely, biological evolution and biochemistry), the data are constrained to a lower-dimensional manifold within this embedding space.
...
% \begin{figure}[ht!]
%     \centering
%     \includegraphics[scale=0.3]{images/geometry/deltas.pdf}
...
\begin{equation*}
    \mathcal{T} \coloneqq \mathcal{O} \big( \lceil d \rceil \cdot \log \mathcal{N}_{\hat{r}}(X) \big).
\end{equation*}
