...
\begin{figure}[ht!]
    ...
    \caption{Scaling behavior of radii in the worst case two-dimensional scenario, 
    a uniform-density disk. $R_0$ denotes the radius of the root cluster $C_0$, and $o_0$ denotes its center. 
    ...
    as shown in $C_2$. Now, clearly $R_2 \leq R_0$. In fact, for each subsequent application of Algorithm~\ref{1},
