...
To make the comparison fair, we also allow CAKES to select the fastest of its algorithms by testing each with a small number of the centers of clusters at low depth as representative queries.
