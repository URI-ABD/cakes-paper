...
\begin{figure}[h]
    ...
    The measured LFD of ``only'' 20 is a consequence of Equation~\ref{eq:methods:lfd-original} and only having sampled $10^6$ points in a 128-dimensional space $(\log_2 10^6 \approx 20)$;
