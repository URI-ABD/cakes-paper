...
We note that when put into a multiple sequence alignment, the length (and thus dimensionality) would be 50,000, but in that case one could use Hamming distance, which is computationally less expensive than Levenshtein distance.
