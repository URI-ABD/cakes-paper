...
CAKES is a set of three algorithms for exact $k$-NN search: Repeated $\rho$-NN, Breadth-First Sieve, and Depth-First Sieve.
In Section~\ref{sec:methods}, we describe the clustering and search algorithms, and provide a theoretical analysis.
