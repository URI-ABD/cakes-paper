...
\begin{abstract}
  ...
  We demonstrate that CAKES exhibits near-constant running time as cardinality grows on data conforming to the manifold hypothesis, and has perfect recall on data in \textit{metric} spaces.
